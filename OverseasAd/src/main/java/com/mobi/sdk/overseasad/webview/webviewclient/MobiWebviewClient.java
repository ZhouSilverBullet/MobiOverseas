...
import static com.mobi.sdk.overseasad.MobiConstantValue.CONTENT_SCHEME;

public class MobiWebviewClient extends WebViewClient {

    private static final String TAG = "MobiWebviewClient";
...
//            return new WebResourceResponse("application/x-javascript", "utf-8", webView.getContext().getAssets().open("jquery.js"));
//        } catch (IOException e) {
//            e.printStackTrace();
